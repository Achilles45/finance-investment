           ...
           <form @submit.prevent="signup()">
               ...
               <div class="form-group">
                  ...
                  <select class="form-control" id="inlineFormCustomSelect" v-model="account_type">
                            ...
                            <option value="50,000" class="pt-4">&#8358;50,000 to &#8358;125,000 (Promo plan)</option>
                             <option value="100,000" class="pt-4">&#8358;100,000 to &#8358;250,000 (Promo plan)</option>
                            ...
                            <option value="500,000">&#8358;500,000 to &#8358;1,000,000 (Promo plan)</option>
                            <option value="600,000">&#8358;600,000 to &#8358;1,350,000 (Promo plan)</option>
                            <option value="700,000">&#8358;700,000 to &#8358;1,500,000 (Promo plan)</option>
                            <option value="800,000">&#8358;800,000 to &#8358;1,750,000 (Promo plan)</option>
                            <option value="900,000">&#8358;900,000 to &#8358;1,850,000 (Promo plan)</option>
