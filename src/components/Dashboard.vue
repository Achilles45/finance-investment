           ...
           <div class="dashboard__right">
             ...
             <hr>
              ...
              <div v-if="verifyuser == 'false'" class="red">
                  Cogratulations. Your account has been successfully created. Please make your payment for verification or call <a href="tel:+2347037104283">+2347037104283</a>
              </div>
              ...
              <hr>
              <p class="note">Kindly note that your investment lifecycle will only begin to count when you have been verified to have made payment for your selected plan. Your returns of 50% of your investment and your capital would be paid back in 4 working days. Also, should you find any difficulties in using the platform, kindly use livechat widget to send a message and our customer success team will respond as soon as possible. Happy investing.</p>
              </div>
            <!--End of Dashboard
            =========================-->
              <br>
