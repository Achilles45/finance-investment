      ...
      <div class="container">
          <div class="row">
              <div class="col-12 text-center text">
                  <h2>Invetment Plans & Pricing</h2>
                  <p>You don't need a lot of money to begin</p>
              </div>
          </div>
          <div class="card__wrapper">
              <div class="card__content card1">
                 ...
                 <div class="body">
                    ...
                    <h6 class="pb-2"><i class="fa fa-check-square"> </i> &#8358;600,000 to &#8358;900,000</h6>
                    <h6 class="pb-2"><i class="fa fa-check-square"> </i> &#8358;700,000 to &#8358;1,000,050</h6>
                    <h6 class="pb-2"><i class="fa fa-check-square"> </i> &#8358;800,000 to &#8358;1,200,050</h6>
               ...
               <!-- <div class="card__content card2">
                 <div class="header text-center">
                     <h4>STANDARD</h4>
                     <h6>&#8358; 100,000</h6>
                 </div>
                 <div class="body">
                    <h6><i class="fa fa-check-square"></i> &nbsp;&nbsp;&nbsp;&nbsp; 24/7 Customer Support</h6>
                    <h6><i class="fa fa-check-square"></i> &nbsp;&nbsp;&nbsp;&nbsp; 25% Return on Investment</h6>
                    <h6 class="pb-2"><i class="fa fa-check-square"></i> &nbsp;&nbsp;&nbsp;&nbsp; 15 Days Investment Cycle</h6>
                    <small>Kindly note your investment cycle starts counting only when we have confirmed your payment. Terms and conditions apply</small><br>
                    <div class="button__holder pt-5">
                         <router-link to="/signup" class="card__btn">Choose Plan</router-link>
                    </div>
                 </div>
               ...
               <div class="card__content card3">
                 ...
                 <div class="body">
                    ...
                    <h6 class="pb-2"><i class="fa fa-check-square"></i> &#8358;200,000 to &#8358;500,000</h6>
                    <h6 class="pb-2"><i class="fa fa-check-square"></i> &#8358;300,000 to &#8358;9000,000</h6>
                    ...
                    <small>Kindly note your investment cycle starts counting only when we have confirmed your payment and you can get your profits in 24 hours. Terms and conditions apply</small><br>
                  <div class="button__holder pt-5">
                         <router-link to="/signup" class="card__btn">Choose Plan</router-link>
                    </div>
                 </div>
